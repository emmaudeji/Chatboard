  ...
  return (
    <div className='section-padding flex min-h-[80vh] justify-center items-center'>
      ...
      <div className='py-10'>
       ...
       <form onSubmit={handleSubmit} className='border border-zinc-300 max-w-[450px] rounded p-3 grid gap-2'>
        ...
        <GoogleLogin
            clientId="125821476576-iqthabqpes2k6h5mlca2e4vmfs07bg9a.apps.googleusercontent.com"
            render={(renderProps) => (
              <button className='' 
